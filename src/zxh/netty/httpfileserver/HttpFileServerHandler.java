...
public class HttpFileServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
	...
	//展示
	private static void sendListing(ChannelHandlerContext ctx, java.io.File dir){
		// 设置响应对象
		...
		//构造结构，写入缓冲区
		ByteBuf buff = Unpooled.copiedBuffer(ret, CharsetUtil.UTF_8);
    ...
    private String sanitizeUri(String uri){
    	...
    	// step 4 二次验证合法性
    	if (uri.contains(java.io.File.separator + '.')
    			|| uri.contains('.' + java.io.File.separator) || uri.startsWith(".")
    	...
    	return System.getProperty("user.dir")+java.io.File.separator+uri;
